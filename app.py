...
def main():
    try:
        ...
        author = Author("Bill Kiprop")
        print(f"Author created with ID: {author.id}, Name: {author.name}")

        
        magazine = Magazine("How to get girls Vol.1", "Real life")
        print(f"Magazine created with ID: {magazine.id}, Name: {magazine.name}, Category: {magazine.category}")

       
        article = Article(author, magazine, "Solving life crisis", "This is based on how to get girls")
